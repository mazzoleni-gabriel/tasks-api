...
// PublishDeleteMessage provides a mock function with given fields: ctx, task
func (_m *Publisher) PublishDeleteMessage(ctx context.Context, task tasks.Task) error {
